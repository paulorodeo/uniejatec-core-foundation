...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "UniEjatec Foundation establishes the technical core for the UniEjatec Platform, providing a structured and scalable base." },
      { property: "og:description", content: "UniEjatec Foundation establishes the technical core for the UniEjatec Platform, providing a structured and scalable base." },
      { name: "twitter:description", content: "UniEjatec Foundation establishes the technical core for the UniEjatec Platform, providing a structured and scalable base." },
      { property: "og:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/de8a4fab-2d42-4c90-b1c7-7e06ebd46478/id-preview-059a9b9f--1041cc86-3830-48db-89b6-6d691135d1a1.lovable.app-1784772955738.png" },
      { name: "twitter:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/de8a4fab-2d42-4c90-b1c7-7e06ebd46478/id-preview-059a9b9f--1041cc86-3830-48db-89b6-6d691135d1a1.lovable.app-1784772955738.png" },
    ],
    links: [
